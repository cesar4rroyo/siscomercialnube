...
{
    protected $folderview      = 'app.movimientostock';
    protected $tituloAdmin     = 'Stock Real';
    protected $tituloRegistrar = 'Registrar Stock Real';
    protected $tituloModificar = 'Modificar Stock Real';
    protected $tituloEliminar  = 'Eliminar Stock Real';
    protected $tituloVer       = 'Ver Stock Real';
    protected $rutas           = array(
        'create' => 'movimientostock.create',
        'edit'   => 'movimientostock.edit',
        'show'   => 'movimientostock.show',
        'delete' => 'movimientostock.eliminar',
        'search' => 'movimientostock.buscar',
        'index'  => 'movimientostock.index',
    );
...
public function colocarstockreal(){
        $movimientos = Movimiento::where('tipomovimiento_id',6)->where('tipodocumento_id',11)->get();
        foreach($movimientos as $movimiento){
            ...
            foreach($detalles as $detalle){
                ...
                if(count($stock)){
                    ...
                    $stocknuevo = new Stockproducto();
                    $stocknuevo->producto_id = $detalle->producto_id;
                    $stocknuevo->sucursal_id = $movimiento->sucursal_id;
                    $stocknuevo->cantidad = $detalle->cantidad;
                    $stocknuevo->save();
                }
            }
        }
    ...
    public function buscar(Request $request)
    {
        ...
        $resultado        = Movimiento::listarDocStock($sucursal, $fecinicio, $fecfin, $tipodocumento, $numero);
        $lista            = $resultado->get();
        $cabecera         = array();
    ...
    public function index()
    {
        ...
        $cboTipoDocumento = Tipodocumento::where('tipomovimiento_id', '=', 6)->orderBy('nombre', 'asc')->pluck('nombre', 'id')->all();
    ...
    public function create(Request $request)
    {
        ...
        $entidad    = 'Movimientostock';
        $movimiento = null;
        $formData   = array('movimientostock.store');
    ...
    public function store(Request $request)
    {
        ...
        try {
            $error = DB::transaction(function () use ($request, $user, &$dat) {
                ...
                $Venta->tipomovimiento_id = 6; //MOV STOCK
    ...
    public function show(Request $request, $id)
    {
        ...
        $formData            = array('movimientostock.update', $id);
    ...
    public function eliminar($id, $listarLuego)
    {
        ...
        $entidad  = 'Movimientostock';
        $formData = array('route' => array('movimientostock.destroy', $id), 'method' => 'DELETE', 'class' => 'form-horizontal', 'id' => 'formMantenimiento' . $entidad, 'autocomplete' => 'off');
        $boton    = 'Eliminar';
    ...
    {
        $numeroventa = Movimiento::NumeroSigue(6, $request->input('tipodocumento'));
