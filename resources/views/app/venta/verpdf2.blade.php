...
<body>
    ...
    <p style=" margin:5px;  text-align:center; font-size:14px; font-weight:bold;">{{$nombre_doc}}</p>
        ...
        <table width='100%' style="  margin-top:5px; border-collapse: collapse; ">
            <tr>
                <td style="width:50%; padding-bottom:5px; text-align:left; height:20px;  border : 0.5px black solid; border-left:none; border-right:none; font-size:13px;  font-weight:bold;">
                    Producto</td>
                <td
                    style="width:15%; padding-bottom:5px; text-align:center; height:20px;  border : 0.5px black solid; border-left:none; border-right:none; font-size:13px;  font-weight:bold;">
                    Cant.</td>
                <td
                    style="width:15%; padding-bottom:5px; text-align:center; height:20px;  border : 0.5px black solid; border-left:none; border-right:none; font-size:13px;  font-weight:bold;">
                    P. Unit.</td>
		...
		?>
            <tr>
            <td style="width:50%;  padding: 1px;  text-align:left;     font-size:13px; ">{{$detalle->producto_id?$detalle->producto->nombre:$detalle->promocion->nombre}}</td>
            <td style="width:15%; padding: 1px; text-align:center;   font-size:13px;  ">{{number_format($detalle->cantidad,2)}}</td>
            <td style="width:15%; padding: 1px; text-align:center;   font-size:13px;  ">{{number_format($detalle->precioventa,2)}}</td>
