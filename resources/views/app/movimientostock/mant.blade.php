            ...
            <div class="row col-lg-12 col-md-12 col-sm-12 p-0 m-0">
                <div class="col-lg-6 col-md-6 col-sm-6 p-0">
                    <div class="form-group">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            {!! Form::select('tipodocumento',$cboTipoDocumento, null, array('class' => 'form-control input-xs', 'id' => 'tipodocumento', 'onchange' => 'generarNumero();actualizarProductos();')) !!}
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6 p-0">
...
function buscarProductoBarra(barra){
    if($(IDFORMMANTENIMIENTO + '{!! $entidad !!} :input[id="sucursal_id"]').val() == ""){
        ...
        $.ajax({
            type: "POST",
            url: "movimientostock/buscarproductobarra",
...
function buscarProducto(valor){
    if($(IDFORMMANTENIMIENTO + '{!! $entidad !!} :input[id="sucursal_id"]').val() == ""){
        ...
        $.ajax({
            type: "POST",
            url: "movimientostock/buscarproducto",
...
function generarNumero(){
    $.ajax({
        type: "POST",
        url: "movimientostock/generarNumero",
